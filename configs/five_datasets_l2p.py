...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--freeze_head', action="store_true")
    subparsers.add_argument('--train_type', default="l2p", type=str)
    subparsers.add_argument('--eval_task_id', action="store_true")
    subparsers.add_argument('--frequency_penalization', action="store_true")
    subparsers.add_argument('--class_incremental', action="store_true")
    subparsers.add_argument('--init_class_prompts', action="store_true")
    subparsers.add_argument('--task_incremental', action="store_true")
    subparsers.add_argument('--init_tasks_prompts', action="store_true")
    subparsers.add_argument('--prompts_per_task', default=4, type=int)
    subparsers.add_argument('--prompts_per_class', default=1, type=int)
    subparsers.add_argument('--freeze_keys', action="store_true")